              ...
              <div className="mx-auto flex w-full max-w-[26rem] flex-1 flex-col justify-center lg:py-6">
                ...
                <form onSubmit={handleLogin} className="flex flex-col gap-4 sm:gap-5 animate-[fadeUp_0.65s_ease-out_0.06s_both]">
                  ...
                  <button
                    type="submit"
                    disabled={submitting}
                    className="mt-1 w-full rounded-full bg-dark-brown py-3.5 text-base font-bold uppercase tracking-wide text-milk shadow-[0_8px_24px_rgba(82,49,34,0.22)] transition-all active:scale-[0.98] hover:bg-[#3a2218] sm:py-4 sm:text-lg disabled:cursor-not-allowed disabled:opacity-70"
                  >
